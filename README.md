...
│   ├── class-admin-debug-vendor-tab.php                # تب دیباگ فروشندگان
│   ├── class-admin-debug-logs-tab.php                  # تب مشاهده و مدیریت لاگ‌ها
│   ├── class-admin-debug-cache-tab.php                 # تب پاکسازی کش
│   ├── class-admin-debug-product-tab.php               # مدیریت وضعیت فروشنده
